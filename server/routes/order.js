...
const { createOrder, deleteOrder, updateOrder, getOrderById, getPendingOrders, getPendingOrdersCount, getAllOrders, getAcceptedOrder, getAcceptedOrderCount, getOrderUpdates } = require('../controller/Order');
...
// SSE route
router.get('/updates',isAuth, getOrderUpdates);
